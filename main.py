...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if pipeSpawnTimer == 0:
            ...
            lower_limit = 120 - 1000
            upper_limit = window_size[1] - 120 - space_between_pipes - 1000

            if upper_limit < lower_limit:
                upper_limit = lower_limit + 100  # Adjust upper limit so it's always greater than lower limit

            top.x, top.y = window_size[0], random.randint(lower_limit, upper_limit)
